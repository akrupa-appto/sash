...
for (const file of ['manifest.json', 'panel.html', 'settings.html', 'offscreen.html', 'mic-permission.html', 'style.css', 'fonts/outfit.woff2']) await copyFile(path.join(root, 'extension', file), path.join(output, file));
